...
public class VpnStatus {
    ...
    public static final byte[] officalkey = {35, 42, -10, 18, 31, 16, 73, 88, -13, 35, -109, -112, -57, -99, 91, -71, 18, -8, -81, 10};
    public static final byte[] officaldebugkey = {38, -24, -39, -12, 66, -127, -29, -100, -39, -51, 110, -71, -2, 95, -75, 7, -85, -122, 13, -78};
    ...
    public static void updateStatePause(OpenVPNManagement.pauseReason pauseReason) {
        switch (pauseReason) {
            ...
            case userPause:
                ...
                break;*/
            case unknown:
                VpnStatus.updateStateString("UNKNOWNPAUSE", "", R.string.state_unknownpause, ConnectionStatus.LEVEL_VPNPAUSED);
                break;
        }
