...
public class ProfileManager {
    ...
    public void saveProfile(Context context, VpnProfile profile) {
        ...
        try {
            vpnfile = new ObjectOutputStream(new GZIPOutputStream(context.openFileOutput((profile.getUUID().toString() + ".vp"), Activity.MODE_PRIVATE)));
    ...
    private void loadVPNList(Context context) {
        ...
        for (String vpnentry : vlist) {
            try {
                ObjectInputStream vpnfile = new ObjectInputStream(new GZIPInputStream(context.openFileInput(vpnentry + ".vp")));
