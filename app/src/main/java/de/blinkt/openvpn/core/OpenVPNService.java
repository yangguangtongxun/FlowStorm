...
import com.hnxy.hxy.app.flowstorm.BuildConfig;
import com.hnxy.hxy.app.flowstorm.R;
import com.hnxy.hxy.app.flowstorm.ui.MainActivity;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    private String getTunConfigString() {
        ...
        //String exRoutes = " exRoutes:" + TextUtils.join("|", mRoutes.getNetworks(false)) + TextUtils.join("|", mRoutesv6.getNetworks(false));
    ...
    private void addLocalNetworksToRoutes() {
        ...
        if (localRoutes == null) {
            VpnStatus.logError("Local route is null");
            return;
        }
